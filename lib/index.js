 ...
 *  FIX: This function now correctly handles multi-byte Unicode characters
 *  by explicitly encoding the string as UTF-8 before converting to hex.
 */
function stringToHex(str) {
  // Use Buffer.from with 'utf8' encoding to correctly handle multi-byte characters.
...
/*
 *  Converts a hexadecimal string in a regular string 
 *  FIX: This function now correctly handles multi-byte Unicode characters
 *  by decoding the hex string into a buffer and then interpreting that buffer as a UTF-8 string.
 */
function hexToString(hex) {
    hex = HexFix(hex);
    // Interpret the buffer as a 'utf8' string to correctly reconstruct multi-byte characters.
